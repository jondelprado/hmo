      ...
      <div class="col-lg-5">
        <div class="card">
          <div class="card-header bg-primary">
            <h4>Create Pre Existing Condition</h4>
          </div>

          <div class="card-body">
            {!! Form::open(['action' => 'PECController@store', 'method' => 'POST']) !!}
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="pec_name" placeholder=" Pre Existing Condition"><br>

              <i class="fas fa-asterisk ast"></i>
              <label>Description</label>
              <textarea name="pec_desc" class="form-control" rows="3" placeholder="Input Description"></textarea>
