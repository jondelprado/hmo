        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <label>Type</label>
              <input type="text" class="form-control" name="room_type" value="{{$room->type}}" placeholder="Input Room Type"><br>

              <i class="fas fa-asterisk ast"></i>
              <label>Description</label>
              <textarea name="room_desc" class="form-control" rows="3" placeholder="Input Room Description">{{$room->description}}</textarea><br>

              <i class="fas fa-asterisk ast"></i>
              <label>Maximum Covered Amount</label>
              <input type="text" class="form-control text-left currency" name="room_amount" value="{{$room->amount}}"
