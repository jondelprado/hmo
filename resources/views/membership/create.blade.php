        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <label>Type</label>
              <input type="text" class="form-control" name="membership_type" placeholder="Input Membership Type"><br>

              <i class="fas fa-asterisk ast"></i>
              <label>Additional Plan Mark-Up Interest</label>
              <div class="input-group">
                <input type="text" class="form-control text-left currency" name="membership_interest"
              ...
              <textarea name="membership_desc" class="form-control" rows="3" placeholder="Input Membership Description"></textarea>
