...
@section('content')
                  ...
                  <div style="margin-top: 5%;" class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control" name="member_first" placeholder="Input First Name" value="{{$member->firstname}}"><br>
                      </div>

                      <div class="col-lg-4">
                        <i class="fas fa-asterisk ast"></i>
                        <label>Last Name</label>
                        <input type="text" class="form-control" name="member_last" placeholder="Input Last Name" value="{{$member->lastname}}"><br>
                      </div>

                      <div class="col-lg-4">
                        <label>Middle Name</label>
                        <input type="text" class="form-control" name="member_middle" placeholder="Input Middle Name" value="{{$member->middlename}}"><br>
                      </div>

                      <div class="col-lg-4">
                        <i class="fas fa-asterisk ast"></i>
                        <label>Birthdate</label>
                        <input type="date" class="form-control" name="member_bday" value="{{$member->bday}}"><br>
                      </div>

                      <div class="col-lg-4">
                        <i class="fas fa-asterisk ast"></i>
                        <label>Age</label>
                        <input type="text" class="form-control" name="member_age" placeholder="Input Member Age" value="{{$member->age}}"><br>
                      </div>
                      ...
                      <div class="col-lg-4">
                        ...
                        <div class="icheck-success d-inline">
                          <input type="radio" name="member_gender" value="Male" id="radio1" {{$male}}>
                          <label for="radio1">Male</label>
                        </div>
                        <div class="icheck-success d-inline check_div">
                          <input type="radio" name="member_gender" value="Female" id="radio2" {{$female}}>
                      ...
                      <div class="col-lg-4">
                        <i class="fas fa-asterisk ast"></i>
                        <label>Height</label>
                        <input type="text" class="form-control" name="member_height" placeholder="Feet" value="{{$member->height}}"><br>
                      </div>

                      <div class="col-lg-4">
                        <i class="fas fa-asterisk ast"></i>
                        <label>Weight</label>
                        <input type="text" class="form-control" name="member_weight" placeholder="Kilogram" value="{{$member->weight}}"><br>
                      </div>
                      ...
                      <div class="col-lg-4">
                        ...
                        @if ($member->civil == "Single")
                          @php
                            $single = "selected";
                          @endphp
                        @elseif ($member->civil == "Married")
                          @php
                            $married = "selected";
                          @endphp
                        @elseif ($member->civil == "Separated")
                          @php
                            $separated = "selected";
                          @endphp
                        @else
                      ...
                      <div class="col-lg-6">
                        <i class="fas fa-asterisk ast"></i>
                        <label>Address</label>
                        <input type="text" class="form-control" name="member_address" placeholder="Input Member Address" value="{{$member->address}}"><br>
                      </div>

                      <div class="col-lg-6">
                        <i class="fas fa-asterisk ast"></i>
                        <label>Occupation</label>
                        <input type="text" class="form-control" name="member_occupation" placeholder="Input Member Occupation" value="{{$member->occupation}}"><br>
                      </div>

                      <div class="col-lg-4">
                        <label>Telephone</label>
                        <input type="text" class="form-control" name="member_telephone" placeholder="Input Member Telephone" value="{{$member->telephone}}"><br>
                      </div>

                      <div class="col-lg-4">
                        <i class="fas fa-asterisk ast"></i>
                        <label>Mobile</label>
                        <input type="text" class="form-control" name="member_mobile" placeholder="Input Member Mobile" value="{{$member->mobile}}"><br>
                      </div>

                      <div class="col-lg-4">
                        <i class="fas fa-asterisk ast"></i>
                        <label>Email</label>
                        <input type="email" class="form-control" name="member_email" placeholder="Input Member Email" value="{{$member->email}}">
                      </div>
                  ...
                  <div style="margin-top: 5%;" class="form-group">
                    <div class="row">
                        ...
                        <select style="width: 100%;" class="form-control select2" name="member_membership">
                          ...
                          @foreach ($memberships as $membership)
                            ...
                            @if ($membership->id == $member->membership_id)
                              ...
                              @endphp
                            @endif
                            <option value="{{$membership->id}}|{{$membership->type}}|{{$membership->interest}}" {{$type}}>{{$membership->type}}</option>
                          @endforeach
                        </select><br><br>
                      ...
                      <div class="col-lg-6">
                        ...
                        <input type="date" class="form-control" name="member_endo" value="{{$member->endo}}">
                      </div>
                      ...
                      <div class="col-lg-6">
                        ...
                        @if ($member->frequency == "Monthly")
                          @php
                            $monthly = "selected";
                          @endphp
                        @elseif ($member->frequency == "Quarterly")
                          @php
                            $quarterly = "selected";
                          @endphp
                        @elseif ($member->frequency == "Semi-Annual")
                          @php
                            $semi = "selected";
                          @endphp
                        @else
                        ...
                        <select style="width: 100%;" class="form-control select2" name="member_frequency">
                          ...
                          <option value="Monthly|12" {{$monthly}}>Monthly</option>
                          <option value="Quarterly|3" {{$quarterly}}>Quarterly</option>
                          <option value="Semi-Annual|2" {{$semi}}>Semi-Annual</option>
                          <option value="Annually|1" {{$annual}}>Annually</option>
                        </select><br><br>
                      </div>
                      ...
                      <div class="col-lg-12">
                        ...
                        <select class="duallistbox" name="member_pec[]" multiple>
                          @foreach ($pecs as $pec)
                            ...
                            @if (in_array($pec->id, $explode_member_pec))
                      ...
                      @if (!empty($member->dependent_id))
                        <div class="card">
                          ...
                          <div class="card-header bg-success">
                            <h5>Member's Dependent(s)</h5>
                          </div>

                          <div style="height: 200px; overflow-y: auto;" class="card-body current_dependent">
                            @foreach ($dependents as $dependent)
                              <div class="col-lg-12">
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <label>Name</label>
                                    <input type="text" class="form-control" name="current_dependent_name[]" value="{{$dependent->name}}"><br>
                                  </div>

                                  <div class="col-lg-6">
                                    <label>Birthdate</label>
                                    <input type="date" class="form-control" name="current_dependent_bday[]" value="{{$dependent->bday}}"><br>
                                  </div>

                                  <div class="col-lg-6">
                                    <label>Relationship</label>
                                    <input type="text" class="form-control" name="current_dependent_relationship[]" value="{{$dependent->relationship}}"><br>
                                  </div>
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    @if ($dependent->civil == "Single")
                                      @php
                                        $depsingle = "selected";
                                      @endphp
                                    @elseif ($dependent->civil == "Married")
                                      @php
                                        $depmarried = "selected";
                                      @endphp
                                    @elseif ($dependent->civil == "Separated")
                                      @php
                                        $depseparated = "selected";
                                      @endphp
                                    @else
                                      @php
                                        $depwidowed = "selected";
                                      @endphp
                                    @endif
                                    <select style="width: 100%;" class="form-control select2" name="current_dependent_civil[]">
                                      <option value="">--Select Civil Status--</option>
                                      <option value="Single" {{$depsingle}}>Single</option>
                                      <option value="Married" {{$depmarried}}>Married</option>
                                      <option value="Widowed" {{$depwidowed}}>Widowed</option>
                                      <option value="Separated" {{$depseparated}}>Separated</option>
                                    </select>
                                  </div>

                                  <input type="hidden" name="current_dependent_id" value="{{$dependent->dependent_id}}">
                                  <input type="hidden" name="dependent_row_id[]" value="{{$dependent->id}}">
  ...
  <script>
    ...
    $(document).ready(function(){
      membership_field_edit();
    });

    function membership_field_edit(){

      var membership_values = $("[name='member_membership']").val().split('|');
      var member_company = "{{$member->company_id}}";
      var member_plan = "{{$member->plan_id}}";
      ...
      if (membership_values[1] == "Corporate") {
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            $.each(data, function(i){
              if (member_company == data[i].id) {
                $("[name='member_company']").append('<option value="'+data[i].id+'|'+data[i].name+'|'+data[i].plan_id+'" selected>'+data[i].name+'</option>');
                company_field_edit();
              }
              else {
        ...
        $.ajax({
          ...
          success:function(data){
            $("[name='member_plan']").find('option').remove().end().append('<option value="">--Select Plan--</option>');
            $.each(data, function(i){
              if (member_plan == data[i].id) {
                $("[name='member_plan']").append('<option value="'+data[i].benefit+'|'+data[i].annual+'|'+data[i].id+'" selected>'+data[i].plan+'</option>');
                plan_field_edit();
                frequency_field_edit();
              }
              else {
    ...
    function company_field_edit(){

      var company_values = $("[name='member_company']").val().split('|');
    ...
    function plan_field_edit(){

      var plan_values = $("[name='member_plan']").val().split('|');
    ...
    function frequency_field_edit(){

      var frequency_values = $("[name='member_frequency']").val().split('|');
    ...
    $("#submit").on("click", function(e){
      ...
      var is_dependent = "{{$member->dependent_id}}";
