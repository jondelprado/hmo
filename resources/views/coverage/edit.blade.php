    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-5">
        ...
        <div class="card">
          ...
          <div class="card-body">
            {!! Form::open(['action' => ['CoverageController@update', $coverage->id], 'method' => 'POST']) !!}
            <div class="form-group">
              ...
              <input type="text" name="coverage_name" value="{{$coverage->coverage}}" class="form-control" placeholder="Input Coverage">
              <br>

              <i class="fas fa-asterisk ast"></i>
              <label>Description</label>
              <textarea name="coverage_desc" class="form-control" rows="3" placeholder="Input Description">{{$coverage->description}}</textarea>
