      ...
      <div class="col-lg-6">
        ...
        <div class="card">
          ...
          <div class="card-header bg-primary">
            <h4>Create Standard Service</h4>
          </div>

          <div class="card-body">
            <div class="form-group">
              @include('include.note')
              {!! Form::open(['action' => 'ServicesStandardController@store', 'method' => 'POST']) !!}
              <i class="fas fa-asterisk ast"></i>
              <label>Service</label>
              <input type="text" class="form-control" name="standard_service" placeholder="Input Service Name"><br>
