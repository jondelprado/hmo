        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              {!! Form::open(['action' => ['ServicesAdditionalController@update', $additional->id], 'method' => 'POST']) !!}
              <i class="fas fa-asterisk ast"></i>
              <label>Service</label>
              <input type="text" class="form-control" name="additional_service" value="{{$additional->additional}}" placeholder="Input Service Name"><br>
